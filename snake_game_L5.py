...
while True:
    ...
    flat_wall_3.penup()
    flat_wall_3.goto(-400, 250)
    flat_wall_3.pendown()
    flat_wall_3.forward(800)

    flat_wall_4 = turtle.Turtle()
    flat_wall_4.width(30)
    flat_wall_4.penup()
    flat_wall_4.goto(-400, -250)
    flat_wall_4.pendown()
    flat_wall_4.forward(800)
    ...
    while True:
        ...
        for x_distance_3 in range(-400, 410, 10):
        ...
        for x_distance_4 in range(-400, 410, 10):
